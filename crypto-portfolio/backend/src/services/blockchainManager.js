...
const FALLBACK_BLOCKCHAINS = [
  ...
  { symbol: 'XRP', name: 'XRP Ledger', icon: '\u2715', hash_pattern: '^[A-F0-9]{64}$',
    address_pattern: '^r[1-9A-HJ-NP-Za-km-z]{24,34}$',
    needs_recipient_address: false, asset_symbol: 'XRP', api_type: 'xrp',
    api_url: 'https://s1.ripple.com:51234/', api_key_env_var: null, is_active: true, is_custom: false },
  ...
  { symbol: 'ADA', name: 'Cardano', icon: '\u2641', hash_pattern: '^[a-fA-F0-9]{64}$',
    address_pattern: '^addr1[a-z0-9]{50,100}$',
    needs_recipient_address: true, asset_symbol: 'ADA', api_type: 'cardano',
    api_url: 'https://api.koios.rest/api/v1', api_key_env_var: null, is_active: true, is_custom: false },
  { symbol: 'TRX', name: 'Tron', icon: '\u25c8', hash_pattern: '^[a-fA-F0-9]{64}$',
    address_pattern: '^T[a-zA-Z0-9]{33}$',
    needs_recipient_address: false, asset_symbol: 'TRX', api_type: 'tron',
    api_url: 'https://api.trongrid.io', api_key_env_var: null, is_active: true, is_custom: false },
  ...
  { symbol: 'DOT', name: 'Polkadot', icon: '\u25cf', hash_pattern: '^0x[a-fA-F0-9]{64}$',
    ...
    api_url: 'https://polkadot.api.subscan.io', api_key_env_var: 'SUBSCAN_API_KEY', is_active: true, is_custom: false },
