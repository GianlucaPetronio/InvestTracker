...
const FALLBACK_BLOCKCHAINS = [
  ...
  { symbol: 'XRP', name: 'XRP Ledger', icon: '\u2715', hash_pattern: '^[A-F0-9]{64}$',
    ...
    needs_recipient_address: false, asset_symbol: 'XRP', api_type: 'unsupported',
    api_url: null, api_key_env_var: null, is_active: true, is_custom: false },
  ...
  { symbol: 'ADA', name: 'Cardano', icon: '\u2641', hash_pattern: '^[a-fA-F0-9]{64}$',
    ...
    needs_recipient_address: false, asset_symbol: 'ADA', api_type: 'unsupported',
    api_url: null, api_key_env_var: null, is_active: true, is_custom: false },
  { symbol: 'TRX', name: 'Tron', icon: '\u25c8', hash_pattern: '^[a-fA-F0-9]{64}$',
    address_pattern: '^T[a-zA-Z0-9]{33}$',
    needs_recipient_address: false, asset_symbol: 'TRX', api_type: 'unsupported',
    api_url: null, api_key_env_var: null, is_active: true, is_custom: false },
  ...
  { symbol: 'DOT', name: 'Polkadot', icon: '\u25cf', hash_pattern: '^0x[a-fA-F0-9]{64}$',
    ...
    needs_recipient_address: false, asset_symbol: 'DOT', api_type: 'unsupported',
    api_url: null, api_key_env_var: null, is_active: true, is_custom: false },
