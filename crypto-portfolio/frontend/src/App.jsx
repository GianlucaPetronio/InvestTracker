    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link to="/settings/blockchains" className="text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors" title="Gestion des blockchains">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Routes>
          ...
          <Route path="/add" element={<AddTransactionWizard />} />
          <Route path="/history" element={<TransactionHistory />} />
          <Route path="/settings/blockchains" element={<BlockchainManager />} />
        </Routes>
      </main>
    </div>
  );
