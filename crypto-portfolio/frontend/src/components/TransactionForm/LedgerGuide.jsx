export default function LedgerGuide({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50"
         onClick={onClose}>
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh]
                    overflow-y-auto p-8"
              ...
              <div className="flex-1">
                ...
                {step.showExample && (
                  <div className="bg-gray-100 dark:bg-slate-700 rounded-lg p-4 font-mono text-sm">
                    ...
                    <p className="text-gray-900 dark:text-slate-200 break-all">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-slate-700">
          <button
            onClick={onClose}
            className="w-full py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold rounded-lg
                     transition-colors"
          >
            J'ai compris !
          </button>
